        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-img-top img-fluid" style="background: url({{getImage($plan->featured_photo_path)}}) no-repeat black; height: 320px; max-height: 320px; background-size: contain; background-position: center; "> </div>
